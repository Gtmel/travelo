  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<VerificationProfilRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VerificationProfilRecord>
            modifierProfilVerificationProfilRecordList = snapshot.data!;
        final modifierProfilVerificationProfilRecord =
            modifierProfilVerificationProfilRecordList.isNotEmpty
                ? modifierProfilVerificationProfilRecordList.first
                : null;
                          ...
                          Padding(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => TextFormField(
                                ...
                                validator: _model.vehiculeNomControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                                ...
                                if (int.parse(_model.ageController.text) >=
                                  ...
                                  if (valueOrDefault<bool>(
                                    ...
                                    if (confirmDialogResponse) {
                                      await modifierProfilVerificationProfilRecord!
                                          .reference
                                          .delete();
                                    } else {
                                      return;
                                  ...
                                  final usersUpdateData = createUsersRecordData(
                                    ...
                                    vehiculeImmatriculation: _model
                                        .vehiculeImmatriculationController.text,
                                    vehicleUrl: _model.uploadedFileUrl2,
